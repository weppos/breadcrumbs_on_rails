...
To define static menus, do it only once by creating an initializer, there will be availlable everywhere in your controllers.
  ...
  BreadcrumbsOnRails.configure do |config|
    ...
    # define_static_breadcrumb takes as argument the symbol name of the breadcrumb to use
    config.define_static_breadcrumb :mainMenu do |b|
      # add_breadcrumb takes the sames arguments as in a controller
      b.add_breadcrumb :home, :root_path
      b.add_breadcrumb :account, :root_path
      b.add_breadcrumb :bien, :root_path
    end
